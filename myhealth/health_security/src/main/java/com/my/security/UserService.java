...
public class UserService implements UserDetailsService {
     ...
     * 通过静态代码块模式数据库
     */
    public static Map<String, com.my.health.pojo.User> map = new HashMap<String, com.my.health.pojo.User>();

    static {
        com.my.health.pojo.User user1 = new com.my.health.pojo.User();
        user1.setUsername("admin");
        user1.setPassword(encoder.encode("admin")); //模拟数据的密码已经加密后的

        com.my.health.pojo.User user2 = new com.my.health.pojo.User();
