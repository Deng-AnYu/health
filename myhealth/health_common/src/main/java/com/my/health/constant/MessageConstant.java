...
public class MessageConstant {
    ...
    public static final String ORDERSETTING_MESSAGE_FAIL = "验证码错误";
    ...
    public static final String LOGIN_FAIL = "登录失败,验证码错误";
    public static final String LOGIN_ERROR = "登录遇到错误";
